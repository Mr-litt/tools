...
class Func
{
     ...
     * @return array
     */
    public static function makeArray($list, $field, $unique = 1 ) {
        $array = array();
        if (!empty($list) ) {
            $list = (array) $list;
     ...
     * @return array
     */
    public static function makeKeyArray($list, $field){
        $array = array();
        if (!empty($list) ) {
            $list = (array) $list;
            foreach ($list as $key => $value) {
     ...
     * @return string
     */
    public static function create_order_id($id,$type=1){
        $pex=($type==1)?"P":"S";
        $num = strlen($id);
        $num = (10-$num)+3;
        $str = '';
